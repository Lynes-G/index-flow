...
const fieldSeparatorClassName =
  "relative -my-2 h-5 text-sm group-data-[variant=outline]/field-group:-mb-2";

const fieldErrorClassName = "text-destructive text-sm font-normal";
...
const fieldVariants = cva(fieldBaseClassName, {
  variants: {
    orientation: {
