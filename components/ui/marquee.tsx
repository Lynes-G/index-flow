...
function Marquee(props: MarqueeProps) {
  ...
  const style = React.useMemo<React.CSSProperties>(
    ...
    [duration, resolvedGap, delay, loopCount, styleProp],
  );
      ...
      <div data-slot="marquee-wrapper" className="grid">
        <MarqueePrimitive
          ...
          className={cn(
            ...
            pauseOnHover && "group",
            pauseOnKeyboard &&
              "focus-visible:border-ring focus-visible:ring-ring/50 rounded-md focus-visible:ring-[3px] focus-visible:outline-none",
            className,
          )}
          style={style}
